...
export const defaultSiteContent: SiteContent = {
  ...
  pricing: {
    ...
    ctaHref: 'https://securelink-prod.valorpaytech.com:4430/?redirect=1&uid=f1093876-5302-11f1-a8e1-12a0879a85b1',
  ...
  adultsBooks: [
    {
      ...
      meetings: 'January 12 and 26',
      time: '6:00 PM',
      imageKey: 'mind-gut-connection',
      isCompleted: true,
    },
    {
      month: 'February 2026',
      ...
      meetings: 'February 9 and 23',
      time: '6:00 PM',
      imageKey: 'book-of-joy',
      isCompleted: true,
    },
    {
      month: 'March 2026',
      ...
      author: 'Brene Brown',
      meetings: 'March 9 and 30',
      time: '6:00 PM',
      imageKey: 'atlas-of-the-heart',
      isCompleted: true,
    },
    {
      month: 'April 2026',
    ...
    },
    {
      ...
      meetings: 'May 11 and 25',
      time: '6:00 PM',
      imageKey: 'sacred-rest',
    },
    {
      month: 'June 2026',
      title: 'Set Boundaries, Find Peace',
      author: 'Nedra Glover Tawwab',
      meetings: 'June 8 and 29',
      time: '6:00 PM',
      imageKey: 'set-boundaries',
    },
    {
      month: 'July 2026',
      title: 'Good Inside',
      author: 'Dr. Becky Kennedy',
      meetings: 'July 13 and 27',
      time: '6:00 PM',
      imageKey: 'good-inside',
    },
    {
      month: 'August 2026',
      title: 'Braving the Wilderness',
      author: 'Brene Brown',
      meetings: 'August 10 and 31',
      time: '6:00 PM',
      imageKey: 'braving-wilderness',
    },
    {
      month: 'September 2026',
      title: 'Money Magic',
      author: 'Laurence Kotlikoff',
      meetings: 'September 14 and 28',
      time: '6:00 PM',
      imageKey: 'money-magic',
    },
    {
      month: 'October 2026',
      title: 'The Lean Startup',
      author: 'Eric Ries',
      meetings: 'October 12 and 26',
      time: '6:00 PM',
      imageKey: 'lean-startup',
    },
    {
      month: 'November 2026',
      title: 'Essentialism',
      author: 'Greg McKeown',
      meetings: 'November 9 and 30',
      time: '6:00 PM',
      imageKey: 'essentialism',
    },
    {
      month: 'December 2026',
      title: 'Your Best Year Ever',
      author: 'Michael Hyatt',
      meetings: 'December 14 and 28',
      time: '6:00 PM',
      imageKey: 'best-year-ever',
    },
  ],
};
